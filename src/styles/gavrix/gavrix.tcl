...
namespace eval ttk::theme::gavrix {

    variable version 0.6
    package provide ttk::theme::gavrix $version
    ...
    LoadImages [file join [file dirname [info script]] img]

    ttk::style theme create gavrix -parent default -settings {
        ttk::style configure . \
       ...
       ttk::style element create Notebook.client \
        ...
        # And at the moment there are no lines as in the gavrix theme
        # And hover, pressed doesn't work
        ttk::style element create Treeitem.indicator \
            image [list $I(folder_close) \
                user2 $I(empty) \
                user1 $I(folder_open) \
                ] \
            -width 25 -sticky w
